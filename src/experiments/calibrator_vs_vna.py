...
def run_v3():
	...
	if mode == "wideband":
		#a = PhaseFrequencyResponsePointsV1("/media/pop/32/calibrator_data_v1/calibrator_v1_2025-04-15T07_46_55+00_00", 3, 1) # Attenuator 5 dB
		#a = PhaseFrequencyResponsePointsV1("/media/pop/32/calibrator_data_v1/calibrator_v1_2025-04-15T07_56_09+00_00", 3, 1) # HPF
		a = PhaseFrequencyResponsePointsV1("/media/pop/32/calibrator_data_v1/calibrator_v1_2025-04-15T07_59_26+00_00", 3, 1) # LPF
		b = PhaseFrequencyResponsePointsV1("/media/pop/32/calibrator_data_v1/calibrator_v1_2025-04-15T07_44_00+00_00", 3, 1) # Thru
	elif mode == "narrowband":
		#a = PhaseFrequencyResponsePointsV1("/media/pop/32/calibrator_data_v1/calibrator_v1_2025-04-15T08_07_26+00_00", 3, 1) # Attenuator 5 dB
		#a = PhaseFrequencyResponsePointsV1("/media/pop/32/calibrator_data_v1/calibrator_v1_2025-04-15T08_12_56+00_00", 3, 1) # HPF
		a = PhaseFrequencyResponsePointsV1("/media/pop/32/calibrator_data_v1/calibrator_v1_2025-04-15T08_15_13+00_00", 3, 1) # LPF
		b = PhaseFrequencyResponsePointsV1("/media/pop/32/calibrator_data_v1/calibrator_v1_2025-04-15T08_05_05+00_00", 3, 1) # Thru
	else:
		assert 0

	spectral = minmaxplot("Hz")
	spectral.xtitle("Частота")
	spectral.ytitle("Смещение фазы (°)")

	factor = 180.0 / np.pi

	adjusted = np.angle( b.q_y * a.q_y.conj() ) * factor

	spectral.trace( b.q_x, adjusted, name=f"Калибратор")
